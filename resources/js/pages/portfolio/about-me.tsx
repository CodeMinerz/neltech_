            ...
            <div className="container mx-auto max-w-5xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    <div className="space-y-6">
                        <h3 className="text-2xl justify-center font-semibold ">Full-stack Developer</h3>
                        <p className="text-muted-foreground">
                            With over 2 years of experience in web development, I specialize
                            in creating responsive, accessable and performant web/desktop 
                            application using modern technologies
                        </p>
                        <p className="text-muted-foreground">
                            I'm passionate about creating solutions to complex problems, 
                            and I'm constantly learning new technologies and tecniques to 
                    ...
                    <div className="grid grid-cols-1 gap-6">
                        <div className="gradient-border p-6 bg-secondary/60 card-hover">
                            <div className="flex items-start gap-4">
                                ...
                                <div className="text-left">
                                    ...
                                    <p className="text-muted-foreground">
                                        Developed a website and web application with modern frameworks.
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="flex items-start gap-4">
                                <div className="p-3 rounded-full bg-primary/10">
                                 ...
                                 <div className="text-left">
                                    ...
                                    <p className="text-muted-foreground">
                                        Manage IT support services and troubleshooting technical issues
                                    </p>
                                </div>
                            </div>
                        </div>
